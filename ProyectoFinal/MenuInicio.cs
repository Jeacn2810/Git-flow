...
namespace ProyectoFinal
{
    public partial class MenuInicio : Form
    {
        ...
        public MenuInicio(Usuario objusuario = null)
        {
            if (objusuario == null)
        ...
        {//creamos el llamodo de lista de permiso para que se pueda presentar la diferentes opciones que ya tenga un usuario
